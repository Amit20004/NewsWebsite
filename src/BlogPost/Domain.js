...
function Domain() {
    ...
    const url = `https://newsapi.org/v2/everything?domains=wsj.com&apiKey=01213c1ff17d49429f9b15ca3cc44e84&pageSize=${pageSize}`;
    ...
    return (
        <>
            ...
            <div className='container'>
                ...
                <div className="row">
                    <h1 className="text-center">Domain News</h1>
                    {
                        bitcoin.filter((item)=>{
